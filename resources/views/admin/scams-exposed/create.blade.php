...
@section('title', 'Add Scam Exposed')

@section('page-title', 'Add Scam Exposed')
@section('page-description', 'Create a new scam exposure')

@section('content')
<form action="{{ route('admin.scams-exposed.store') }}" method="POST" class="space-y-6">
    @csrf
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea name="short_description_en" rows="3" required
                                  class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-primary focus:border-transparent @error('short_description_en') border-red-500 @enderror">{{ old('short_description_en') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="short_description_kn" rows="3"
                                  class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-primary focus:border-transparent">{{ old('short_description_kn') }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea name="description_en" id="description_en" rows="10"
                                  class="w-full border border-gray-300 rounded-lg px-4 py-2 ckeditor @error('description_en') border-red-500 @enderror">{{ old('description_en') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="description_kn" id="description_kn" rows="10"
                                  class="w-full border border-gray-300 rounded-lg px-4 py-2 ckeditor">{{ old('description_kn') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div id="featuredMediaPreview" class="mb-4 hidden">
                ...
                <input type="hidden" name="featured_media_id" id="featuredMediaId" value="{{ old('featured_media_id') }}">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div id="galleryMediaPreview" class="grid grid-cols-3 gap-2 mb-4"></div>
