...
@section('title', 'Edit Scam Exposed')

@section('page-title', 'Edit Scam Exposed')
@section('page-description', 'Update scam exposure')

@section('content')
<form action="{{ route('admin.scams-exposed.update', $scamExposed) }}" method="POST" class="space-y-6">
    @csrf
    @method('PUT')
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="title_en" value="{{ old('title_en', $scamExposed->title_en) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="title_kn" value="{{ old('title_kn', $scamExposed->title_kn) }}"
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea name="short_description_en" rows="3" required
                                  class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-primary focus:border-transparent @error('short_description_en') border-red-500 @enderror">{{ old('short_description_en', $scamExposed->short_description_en) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="short_description_kn" rows="3"
                                  class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-primary focus:border-transparent">{{ old('short_description_kn', $scamExposed->short_description_kn) }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea name="description_en" id="description_en" rows="10"
                                  class="w-full border border-gray-300 rounded-lg px-4 py-2 ckeditor @error('description_en') border-red-500 @enderror">{{ old('description_en', $scamExposed->description_en) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="description_kn" id="description_kn" rows="10"
                                  class="w-full border border-gray-300 rounded-lg px-4 py-2 ckeditor">{{ old('description_kn', $scamExposed->description_kn) }}</textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <select name="status" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-primary focus:border-transparent">
                            <option value="active" {{ old('status', $scamExposed->status) === 'active' ? 'selected' : '' }}>Active</option>
                            <option value="inactive" {{ old('status', $scamExposed->status) === 'inactive' ? 'selected' : '' }}>Inactive</option>
                        </select>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Sort Order</label>
                        <input type="number" name="sort_order" value="{{ old('sort_order', $scamExposed->sort_order) }}" min="0"
                               class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-primary focus:border-transparent">
                    </div>
                </div>
                <div class="mt-6 flex gap-3">
                    ...
                    <a href="{{ route('admin.scams-exposed.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors">
                        Cancel
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div id="featuredMediaPreview" class="mb-4 {{ $scamExposed->featuredMedia ? '' : 'hidden' }}">
                    @if($scamExposed->featuredMedia)
                    <img id="featuredMediaImage" src="{{ $scamExposed->featuredMedia->url }}" alt="Featured" class="w-full h-40 object-cover rounded-lg">
                    @else
                ...
                <input type="hidden" name="featured_media_id" id="featuredMediaId" value="{{ old('featured_media_id', $scamExposed->featured_media_id) }}">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div id="galleryMediaPreview" class="grid grid-cols-3 gap-2 mb-4">
                    @foreach($scamExposed->media as $galleryItem)
