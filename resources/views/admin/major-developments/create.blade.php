...
@section('title', 'Add Major Development')

@section('page-title', 'Add Major Development')
@section('page-description', 'Create a new major development project')

@section('content')
<form action="{{ route('admin.major-developments.store') }}" method="POST" class="space-y-6">
    @csrf
