...
@section('title', 'Add Official Media')

@section('page-title', 'Add Official Media')
@section('page-description', 'Add official media content')

@section('content')
<form action="{{ route('admin.official-media.store') }}" method="POST" class="space-y-6">
    @csrf
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div id="social-link-section" class="hidden">
            ...
            <input type="url" name="social_link" id="social_link" value="{{ old('social_link') }}" 
    ...
    <div class="flex justify-end gap-4">
        ...
        <button type="submit" class="px-6 py-2 bg-primary text-white rounded-lg hover:bg-primary/90">Add Official Media</button>
    </div>
</form>
