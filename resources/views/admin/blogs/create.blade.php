...
@section('page-description', 'Create a new blog post')
...
<form action="{{ route('admin.blogs.store') }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 gap-6 mt-4">
            <div>
                ...
                <textarea id="content_en" name="content_en" rows="8"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg">{{ old('content_en') }}</textarea>
            </div>
            <div>
                ...
                <textarea id="content_kn" name="content_kn" rows="8"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg">{{ old('content_kn') }}</textarea>
            </div>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-2 max-h-64 overflow-y-auto p-2 border border-gray-200 rounded-lg">
            <label class="relative cursor-pointer group">
                <input type="radio" name="featured_media_id" value="" class="sr-only peer" checked>
    ...
    <div class="flex justify-end gap-4">
        ...
        <button type="submit" class="px-6 py-2 bg-primary text-white rounded-lg hover:bg-primary/90">Add Blog</button>
    </div>
</form>
@endsection
